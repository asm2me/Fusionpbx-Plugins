...
if (!class_exists('reseller')) {
	class reseller {
		...
		public function create_domain($reseller_uuid, $domain_data) {
			...
			$p = new permissions;
			$p->add('v_reseller_domains_add', 'temp');
			...
			$p->delete('v_reseller_domains_add', 'temp');
		...
		public function delete_domain($reseller_uuid, $domain_uuid) {
			...
			$p = new permissions;
			$p->add('v_domains_delete', 'temp');

			$database = new database;
			$database->execute($sql, $parameters);
			unset($parameters);

			$p->delete('v_domains_delete', 'temp');
		...
		public function calculate_commission($reseller_uuid, $payment_uuid) {
			...
			$p = new permissions;
			$p->add('v_reseller_commissions_add', 'temp');
			...
			$p->delete('v_reseller_commissions_add', 'temp');
