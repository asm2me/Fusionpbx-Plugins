<?php
	...
	$apps[$x]['menu'][0]['icon'] = 'fa-money-bill-wave';
	$apps[$x]['menu'][0]['path'] = '';
	$apps[$x]['menu'][0]['order'] = '';
	...
	$apps[$x]['menu'][1]['icon'] = 'fa-tachometer-alt';
	...
	$apps[$x]['menu'][2]['icon'] = 'fa-list-alt';
	...
	$apps[$x]['menu'][3]['icon'] = 'fa-sync-alt';
	...
	$apps[$x]['menu'][4]['icon'] = 'fa-file-invoice-dollar';
	...
	$apps[$x]['menu'][5]['icon'] = 'fa-credit-card';
	...
	$apps[$x]['menu'][6]['icon'] = 'fa-envelope';
