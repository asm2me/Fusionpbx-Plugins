...
//handle delete
	if ($_REQUEST['action'] == 'delete' && permission_exists('billing_plans_delete')) {
		//validate the token
		$token = new token;
...
//show the content
	...
	if (permission_exists('billing_plans_add')) {
	...
	if (permission_exists('billing_plans_edit') || permission_exists('billing_plans_delete')) {
	...
	if (is_array($plans) && count($plans) > 0) {
		foreach ($plans as $row) {
			...
			if (permission_exists('billing_plans_edit')) {
			...
			if (permission_exists('billing_plans_edit') || permission_exists('billing_plans_delete')) {
				...
				if (permission_exists('billing_plans_delete')) {
