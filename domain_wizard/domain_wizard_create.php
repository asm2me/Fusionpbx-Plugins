...
//javascript for wizard navigation and form handling
	...
	echo "			try {\n";
	echo "				var result = JSON.parse(xhr.responseText);\n";
	...
	echo "							logDiv.innerHTML += '<div>' + result.log[i] + '</div>';\n";
	echo "						}\n";
	echo "					}\n";
	echo "					setTimeout(function() { window.location.href = 'domain_wizard.php'; }, 3000);\n";
	echo "				} else {\n";
	echo "					document.getElementById('progress-bar').style.background = '#f44336';\n";
	echo "					logDiv.innerHTML = '<div style=\"color: #f44336; font-weight: bold;\">".$text['message-domain_failed']."</div>';\n";
	echo "					if (result.message) {\n";
	echo "						logDiv.innerHTML += '<div>' + result.message + '</div>';\n";
	echo "					}\n";
	...
	echo "			} catch(ex) {\n";
	echo "				document.getElementById('progress-bar').style.background = '#f44336';\n";
	echo "				document.getElementById('progress-log').innerHTML = '<div style=\"color: #f44336;\">Unexpected error occurred.</div>';\n";
	echo "				document.getElementById('btn_confirm').disabled = false;\n";
	echo "				document.getElementById('btn_confirm').innerHTML = '".$text['button-confirm']."';\n";
	echo "			}\n";
	echo "		}\n";
