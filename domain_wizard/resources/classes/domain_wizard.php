...
class domain_wizard {
	...
	public function clone_ring_groups($source_uuid, $target_uuid, $count) {
		...
		if (is_array($source_rgs)) {
			...
			$p->delete('v_ring_group_add', 'temp');
		}
	...
	public function log_action($data) {
		...
		$p = new permissions;
		$p->add('v_domain_wizard_log_add', 'temp');
		...
		$p->delete('v_domain_wizard_log_add', 'temp');
	}
