		...
		//validate the data
			...
			if (strlen($msg) > 0) {
				...
				//save to the database
					$p = new permissions;
					$p->add('v_domain_wizard_templates_add', 'temp');
					$p->add('v_domain_wizard_templates_edit', 'temp');
					...
					$p->delete('v_domain_wizard_templates_add', 'temp');
					$p->delete('v_domain_wizard_templates_edit', 'temp');
